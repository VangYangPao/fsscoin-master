...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FSS features */
        {"fss", "masternode", &masternode, true, true, false},
        {"fss", "masternodelist", &masternodelist, true, true, false},
        {"fss", "mnbudget", &mnbudget, true, true, false},
        {"fss", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"fss", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fss", "mnsync", &mnsync, true, true, false},
        {"fss", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fssd, or the -server option to fss-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"FSS Alert\" admin@foo.com\n"),
...
{
    return "> fss-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29778/\n";
}
