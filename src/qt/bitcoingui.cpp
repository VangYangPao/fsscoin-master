                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FSS-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FSS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fss: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FSS Core"), this);
    aboutAction->setStatusTip(tr("Show information about FSS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FSS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FSS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FSS addresses"));
    ...
    openAction->setStatusTip(tr("Open a FSS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FSS Core help message to get a list with possible FSS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FSS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FSS network", "", count));
}
...
{
    QString strTitle = tr("FSS Core"); // default title
