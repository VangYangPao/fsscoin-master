...
{
    const char* pszTimestamp = "19-05-2018 - fss masternode coin";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
		(0, uint256("0x0000052baa5982e0a46e7a4b7b356db0bc611aa8cca6146648ec0fd0a996756b"))
		;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1525351609, 2304118, 0x1e0ffff0, 1, 0 * COIN);

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000052baa5982e0a46e7a4b7b356db0bc611aa8cca6146648ec0fd0a996756b"));
        assert(genesis.hashMerkleRoot == uint256("0x662500d26e05e445220a720b8fc4a8c864bd6e3fd719f191de940427dadbabbc"));
		
		vSeeds.push_back(CDNSSeedData("sv1.fssproject.net", "sv1.fssproject.net"));
		vSeeds.push_back(CDNSSeedData("sv2.fssproject.net", "sv2.fssproject.net"));
		vSeeds.push_back(CDNSSeedData("sv3.fssproject.net", "sv3.fssproject.net"));
